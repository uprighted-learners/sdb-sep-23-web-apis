...
//     president.year >= 1900 ? results.push(president) : null;
// }
// console.log(results)

const presidents1900 = presidents.filter(president => president.year >= 1900)
console.log(presidents1900)

// ? Utilize your new filtered array, use forEach to print a string interpolated name of each president.
